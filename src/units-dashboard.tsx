...
export default function UnitsDashboard() {
  ...
  const handlePermissionChange = (unit: MilitaryUnit, canSeeAllUnits: boolean) => {
  ...
  const getCommanderForUnit = (unit: MilitaryUnit | null) => {
      if (!unit || !users) return null;
                    ...
                    <TableCell className="text-right">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align='end'>
                                <DropdownMenuItem onClick={() => handleDeleteClick(unit)} className="text-destructive focus:bg-destructive/20 focus:text-destructive">
        ...
        {selectedUnit ? (
          <Card className="flex-grow">
            ...
            <CardContent className="space-y-6">
                ...
                <div className='space-y-2'>
                    <h3 className='font-semibold'>Koordinatlar (Placeholder)</h3>
                ...
                <div className='space-y-2'>
                    ...
                    <p>{isLoadingUsers ? 'Yüklənir...' : getCommanderUsername(selectedUnit.commanderId)}</p>
                </div>
                  ...
                  <div className='space-y-4 rounded-lg border p-4'>
                      ...
                      <div className="flex items-center justify-between">
                          <Label htmlFor="can-see-all-units" className='flex-grow pr-4'>
                              ...
                              <p className='text-xs text-muted-foreground'>Aktiv olduqda, bu komandir xəritədə bütün bölükləri və hədəfləri görə biləcək.</p>
                          </Label>
                          <Switch 
